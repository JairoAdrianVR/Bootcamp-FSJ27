...
let cubito = new Cubo('Madera');
let cubito2 = new Cubo('Tierra');
console.log(cubito);
console.log(cubito2);

//Ejemplos de clases PREEXISTENTES EN JS 
let array = new Array(); //Se reemplazo por []
